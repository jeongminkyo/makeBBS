...
<body>
	<%
		...
		Bbs bbs = new MoneyDAO().getBbs(bbsID);
	%>
	...
	<div class="container">
		<div class="row">
			...
			<a href="money.jsp" class="btn btn-primary">목록</a>
			<%
				if(userID !=null && userID.equals(bbs.getUserID()))
				{
			%>
					<a href="updatemoney.jsp?bbsID=<%=bbsID %>" class="btn btn-primary">수정</a>
					<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteMoneyAction.jsp?bbsID=<%=bbsID %>" class="btn btn-primary">삭제</a>
			<%	
				}
			%>
